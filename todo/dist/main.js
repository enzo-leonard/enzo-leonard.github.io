...
const list = [
    ...
    { name: "Fetch API", state: true },
    { name: "Faire un robot (animation)", state: false },
    { name: "Couleur update", state: false }
  ];
...
_lib_data__WEBPACK_IMPORTED_MODULE_1__["default"].forEach((item) => {
...
var sortable = sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"].create(root);
